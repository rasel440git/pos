...
class PurchaseReportsController extends Controller
{
    ...
    public function index(Request $request){
        ...
        $this->data['purchases']= PurchaseItem::select('purchase_items.quantity','purchase_items.price','purchase_items.total','products.title','purchase_invoices.invoice_id','purchase_invoices.date')
