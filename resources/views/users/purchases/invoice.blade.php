...
@section('user_contant')
            ...
            <div class="invoice_item">
                <table class="table table-borderless">
                    ...
                    <tr>
                      ...
                      <tr>
                        <th></th>   
                        <th> <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#newPaymentForInvoice">
     ...
     <div class="modal fade" id="newProcuct" tabindex="-1" role="dialog" aria-labelledby="newProcuctModalLavel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-content">
                ...
                <h5 class="modal-title" id="newProcuctModalLavel">Add New Product</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          {{ Form::text('price', NULL, [ 'class'=>'form-control', 'id' => 'price','required', 'onkeyup' => 'getTotal()', 'placeholder' => 'Unit price' ]) }}
                        </div>
                      </div>
    ...
    <!-- New Payments for Invoice-->
    <div class="modal fade" id="newPaymentForInvoice" tabindex="-1" role="dialog" aria-labelledby="newPaymentForInvoiceModalLavel" aria-hidden="true">
        <div class="modal-dialog" role="document">

            {!! Form::open([ 'route' => ['user.payments.store', [$user->id, $invoice->id]], 'method' => 'post' ]) !!}	
            <div class="modal-content">
                <div class="modal-header">
                <h5 class="modal-title" id="newPaymentForInvoiceModalLavel">New Payments for this invoice</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
                </div>
